...
$.keyboard = function(el, options){
	...
	//$('#txtkeyboard').keypad({randomiseNumeric: true});
	
	//$.keypad({randomiseAll :true});

	//$.ui-keyboard({randomiseAlphabetic :true});
	...
	base.init = function(){
		...
		base.mappedKeys = ({randomiseAlphabetic: true}); // for refresh same as below
		base.acceptedKey=({randomiseAlphabetic: true}); // FOR CHANGE OF KEYS SEQUENCE AT EVERY REFRESH
...
//</script>       
	...
	$.keyboard.defaultOptions = {
		...
		// *** choose layout & positioning ***
			...
			layout       : 'qwerty',
			//layout: $.keypad.qwertyLayout,      a change is made
			//randomiseAlphabetic: true,
			//randomiseNumeric: true, 
		//	randomiseOther: true,
			
			//$('#txt  layout : $.keypad.qwertyLayout, randomiseAlphabetic:true
		customLayout : null,
...
/* a change made
if (!$(this).is(':checked')) {
    $('#textbox').keypad('destroy');
    $('#textbox').keypad('destroy');
} else {
    $('#textbox').keypad({ keypadOnly: true, layout: $.keypad.qwertyLayout, randomiseAlphabetic: true, randomiseNumeric: true, randomiseOther: true });
    $('#textbox').keypad({ keypadOnly: true, layout: $.keypad.qwertyLayout, randomiseAlphabetic: true, randomiseNumeric: true, randomiseOther: true });                    
}*/
