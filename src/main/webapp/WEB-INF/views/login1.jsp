	...
	<div class="header navbar navbar-fixed-top" role="banner">
		...
		<div class="container">
			...
			<a class="navbar-brand" href="index.html"> <img
				src="resources/bootstrap/img/master_logo.png" alt="logo" />
	...
	<form class="form-vertical login-form"
		...
		<div class="col-sm-6 col-sm-6 col-sm-offset-0 my-login-div"
			...
			<p class="form-group userId_box">
				...
				<i class="icon-lock input-group "></i> <input type="password"
					class="txtField" value="" name="password" maxlength="60"
					placeholder="******" data-rule-required="true"
					data-msg-required="Please enter your password."> <br>
				<span class="clearfloat"></span>
			</p>

			<p class="userId_box chkbox"
				style="margin-top: -21px; margin-left: 8%">
				<a data-no-turbolink="" href="#"
					style="top: 8px; position: relative;"
					class="lightBlue_link fgt_pwd">Forgot Password?</a> <span
					class="rcContainer"> <input type="checkbox"
					class="rc remember_me" name="remember_me" id="remember_me">
					<label class="keep_logged_in" for="remember_me">Remember me</label>
				</span> <span class="clearfloat"></span>
			</p>

			<p class="signin_btn">
				<button type="submit"
					style="position: relative; margin: auto; width: 78%"
					class=" actionbutton loginBtn large success btn-embossed">
